...
const Account = () => {
    ...
    return (
        <div className="account-page min-h-screen bg-gray-100">
            <Header />
        ...
        <div className="flex justify-center mb-6 px-4">
            <div className="flex flex-wrap justify-center bg-gray-900 rounded-xl shadow-lg w-full max-w-md overflow-hidden py-3 gap-4 sm:gap-8">
                <button
                    ...
                    className={`px-6 sm:px-10 py-2 text-sm font-semibold rounded-lg transition-colors duration-300 ${isLogin
